...
/*   Updated: 2024/09/13 20:38:27 by abaiao-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Observer Interface for the Bell System
class IBellObserver
{
public:
    virtual ~IBellObserver() = default;
    virtual void onBellRing(Event event) = 0;
};
...
class Professor : public Staff, public IBellObserver
{
private:
...
public:
    ...
    // Bell Observer
    void onBellRing(Event event) override;
};

class Student : public Person, public IBellObserver
{
private:
...
private:
    ...
    std::vector<IBellObserver*> _bellObservers;
...
public:
    ...
    // Add Bell Observer
    void addBellObserver(IBellObserver* observer);
    void removeBellObserver(IBellObserver* observer);
    void ringBell();
